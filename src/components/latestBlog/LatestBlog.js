...
const LatestBlog = () => {
  return (
    <>
      <div className="grow-with-us mx-auto text-center py-16 container">
        <div className="text">
          ...
          <p className="mb-10 font-semibold text-[18px]">
            You can relay on our amazing features list and also our customer services will be <br /> great experience for you without doubt and in no-time
          </p>
        </div>
